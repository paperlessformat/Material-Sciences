...
V = a^3; %the volume formula will be different if not CUB

%%Calculate mass of the n atoms
M = 100; %in unit of g/mol for that particular element

m = M/(6.022*10^23) * n; %coverting g/mol to g/atoms with Avogadro's number, then multiple by n atoms, the final unit is in grams
